...
Elm.Rabbit = Elm.Rabbit || {};
Elm.Rabbit.make = function (_elm) {
   "use strict";
   _elm.Rabbit = _elm.Rabbit || {};
   if (_elm.Rabbit.values) return _elm.Rabbit.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var aiCellStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                     ,_0: "background-color"
                                                     ,_1: "red"}]));
   var emptyCellStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                        ,_0: "background-color"
                                                        ,_1: "chartreuse"}]));
   var blockedCellStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                          ,_0: "background-color"
                                                          ,_1: "black"}
   ...
   var cellStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                  ...
                                                  ,{ctor: "_Tuple2",_0: "border",_1: "1px dotted silver"}]));
   ...
   var rootPosition = {x: 1,y: 1};
   var initialAi = {position: rootPosition,hasCargo: false};
   var PlaceBlock = {ctor: "PlaceBlock"};
   var Pause = {ctor: "Pause"};
   var Start = {ctor: "Start"};
   var NoOp = {ctor: "NoOp"};
   var actions = $Signal.mailbox(NoOp);
   var Field = function (a) {    return {cells: a};};
   var Coordinate = F2(function (a,b) {    return {x: a,y: b};});
   var ContainsSheep = {ctor: "ContainsSheep"};
   var Blocked = {ctor: "Blocked"};
   var cell1 = {coordinate: {x: 0,y: 0},fieldType: Blocked};
   var cell2 = {coordinate: {x: 1,y: 0},fieldType: Blocked};
   var cell3 = {coordinate: {x: 2,y: 0},fieldType: Blocked};
   var cell4 = {coordinate: {x: 0,y: 1},fieldType: Blocked};
   var cell6 = {coordinate: {x: 2,y: 1},fieldType: Blocked};
   var cell7 = {coordinate: {x: 0,y: 2},fieldType: Blocked};
   var cell8 = {coordinate: {x: 1,y: 2},fieldType: Blocked};
   var cell9 = {coordinate: {x: 2,y: 2},fieldType: Blocked};
   var Empty = {ctor: "Empty"};
   var cell5 = {coordinate: {x: 1,y: 1},fieldType: Empty};
   var emptyField = {cells: _U.list([cell1
                                    ,cell2
                                    ,cell3
                                    ,cell4
                                    ,cell5
   ...
   var Cell = F2(function (a,b) {
      return {coordinate: a,fieldType: b};
   });
   var Down = {ctor: "Down"};
   var Up = {ctor: "Up"};
   var Right = {ctor: "Right"};
   var Left = {ctor: "Left"};
   var Sheep = F2(function (a,b) {
      return {position: a,moveDirection: b};
   });
   var AI = F2(function (a,b) {
      return {position: a,hasCargo: b};
   });
   var Model = F4(function (a,b,c,d) {
      return {ai: a,sheeps: b,field: c,score: d};
   });
   return _elm.Rabbit.values = {_op: _op
                               ,Model: Model
                               ,AI: AI
                               ,Sheep: Sheep
                               ,Left: Left
                               ...
                               ,cell9: cell9
                               ,cellStyle: cellStyle
                               ,blockedCellStyle: blockedCellStyle
                               ,emptyCellStyle: emptyCellStyle
                               ,aiCellStyle: aiCellStyle};
};
